...
pub static MODULE_REQUEST: ModuleRequest =
    ModuleRequest::new().with_internal_modules(&[
        ...
        &InternalModule::new().with_path(LOGD_PATH),
        ...
        &InternalModule::new().with_path(SOUND_SERVER_PATH),
